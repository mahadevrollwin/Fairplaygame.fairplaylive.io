...
export const fallbackSiteSettings: SiteSettings = {
  ...
  footer: {
    ...
    email: undefined,
    copyright: 'Â© 2026 Fairplay. All Rights Reserved.',
  },
}
...
export const fallbackHomePage: HomePage = {
  ...
  aboutSection: {
    ...
    eyebrow: 'Transparency â€¢ Security â€¢ Excitement',
    paragraphs: [
...
export const fallbackPosts: PostDetail[] = (
  ...
  blockquote: {
    text: "Live betting isn't about guessing who wins the matchâ€”it's about identifying momentary odds misprices created by crowd emotion and temporary overreactions.",
    cite: 'Rohan Sharma, Senior Sports Analyst',
  },
  tags: ['#IPL2026', '#CricketBetting', '#LiveOdds', '#BettingTips', '#Fairplay'],
}))
